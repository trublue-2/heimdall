...
CREATE TABLE "new_Device" (
    ...
    "emergencyOpensLeft" INTEGER NOT NULL DEFAULT 3,
    "battery" INTEGER,
    "boltPos" TEXT,
    "fwVersion" TEXT,
    "mac" TEXT,
